export type PaletteColorKey = "pink" | "orange" | "yellow" | "blue" | "green" | "cyan" | "purple";
...
export const PALETTE_COLORS = [
  ...
  { key: "purple", name: "Ungu", hex: "#BC71FE", class: "sakode-purple", secondary: "pink" },
] as const;
...
export const getBgClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple";
  }
};
...
export const getBgOpacity90Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/90";
  }
};
...
export const getBgHoverClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "hover:bg-sakode-purple";
  }
};
...
export const getBorderHoverClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "hover:border-sakode-purple";
  }
};
...
export const getShadow20Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "shadow-sakode-purple/20";
  }
};
...
export const getBgOpacity25Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/25";
  }
};
...
export const getBgOpacity20Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/20";
  }
};
...
export const getBgOpacity15Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/15";
  }
};
...
export const getBgOpacity10Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/10";
  }
};
...
export const getBgOpacity5Class = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "bg-sakode-purple/5";
  }
};
...
export const getTextClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "text-sakode-purple";
  }
};
...
export const getBorderClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "border-sakode-purple";
  }
};
...
export const getFocusRingClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "focus:ring-sakode-purple/35";
  }
};
...
export const getGradientClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "from-sakode-purple to-sakode-pink";
  }
};
...
export const getGradientBgLightClass = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "from-sakode-purple/15 to-sakode-pink/20";
  }
};
...
export const getLiquidGlassShadow = (color: PaletteColorKey) => {
  switch (color) {
    ...
    case "purple": return "dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.5),_0_0_20px_-3px_rgba(188,113,254,0.15)]";
  }
};
