    ...
    <div className="flex flex-col gap-6 text-left py-4">
      <div>
        <h1 className="text-xl md:text-2xl font-black text-zinc-900 dark:text-white">
          Booking Kelas Trial Gratis
        </h1>
        <p className="text-xs text-zinc-500 mt-1">
          Pilih topik pemrograman dan jadwalkan sesi kelas perkenalan gratis Anda.
        </p>
      </div>

      <UI.Card accentColor={selectedColor}>
        <div className="p-6 text-center text-xs text-zinc-500 font-semibold">
          Halaman booking trial gratis sedang dipersiapkan dan akan diimplementasikan pada feature slice berikutnya.
        </div>
      </UI.Card>
    </div>
  );
