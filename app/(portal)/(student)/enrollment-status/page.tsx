    ...
    <div className="flex flex-col gap-6 text-left py-4">
      <div>
        ...
        <p className="text-xs text-zinc-500 mt-1">
          Pantau progress verifikasi berkas, riwayat checkout pendaftaran, cicilan, dan promo Anda.
        </p>
      </div>

      <UI.Card accentColor={selectedColor}>
        <div className="p-6 text-center text-xs text-zinc-500 font-semibold">
          Halaman status pendaftaran siswa sedang dipersiapkan dan akan diimplementasikan pada feature slice berikutnya.
        </div>
      </UI.Card>
    </div>
  );
