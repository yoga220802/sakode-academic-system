...
export default function RegistrationReviewPage() {
  ...
  const [selectedInstallmentTerm, setSelectedInstallmentTerm] =
    useState<InstallmentTerm | null>(null);
  const [selectedGroupMemberPayment, setSelectedGroupMemberPayment] =
    useState<GroupMemberPayment | null>(null);
  ...
  const [items, setItems] = useState<RegistrationItem[]>([
    ...
    },
    {
      ...
      installments: [
        ...
        {
          termNumber: 2,
          termName: "Cicilan 2 - Pelunasan (50%)",
          dueDate: "14 Apr 2026",
          amount: 1400000,
          status: "pending_upload",
        },
    ...
    },
    {
      ...
      groupMemberPayments: [
        {
          memberName: "Charles Go",
          amount: 250000,
          status: "paid",
          receiptUrl: "bukti_charles_go_bca.jpg",
          receiptUploadedDate: "11 Mar 2026 09:40 WIB",
        },
        {
          memberName: "Dendi Kurniawan",
          amount: 250000,
          status: "pending_upload",
        },
        {
          memberName: "Eka Prasetya",
          amount: 250000,
          status: "paid",
          receiptUrl: "bukti_eka_prasetya_mandiri.jpg",
          receiptUploadedDate: "11 Mar 2026 09:45 WIB",
        },
      ],
    },
    {
      ...
      installments: [
        {
          termNumber: 1,
          termName: "Cicilan 1 - DP (40%)",
          dueDate: "11 Mar 2026",
          amount: 1600000,
          status: "paid",
          receiptUrl: "bukti_cicil1_joko_bca.jpg",
          receiptUploadedDate: "10 Mar 2026 09:30 WIB",
        },
        {
          termNumber: 2,
          termName: "Cicilan 2 - Termin 2 (30%)",
          dueDate: "11 Apr 2026",
          amount: 1200000,
          status: "pending_upload",
        },
        {
          termNumber: 3,
          termName: "Cicilan 3 - Pelunasan (30%)",
          dueDate: "11 Mei 2026",
          amount: 1200000,
          status: "pending_upload",
        },
  ...
  const handleSimulateInstallmentUpload = (
    item: RegistrationItem,
  ...
  const handleSimulateGroupMemberUpload = (
    item: RegistrationItem,
    memberName: string,
  ) => {
  ...
  const handleToggleGroupPaymentMode = (
    item: RegistrationItem,
    mode: "merged" | "individual",
  ) => {
    setItems((prev) =>
      prev.map((i) => {
        if (i.id === item.id) {
    ...
    <div className="flex flex-col gap-10 w-full text-left font-sans pb-16">
              ...
              {simulationState === "loading" ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 max-w-xs mb-4">
                    Koneksi database terputus. Silakan coba lagi atau reset data
                    simulasi.
                  </p>
                  <UI.Button
                    variant="secondary"
                ...
                <div className="flex flex-col items-center justify-center py-14 px-4 text-center">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 max-w-xs">
                    Tidak ada siswa baru yang sesuai dengan kata kunci pencarian
                    atau filter aktif.
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center gap-2">
                          ...
                          <div className="flex items-center gap-1.5 shrink-0">
                            ...
                            <UI.Badge
                              variant={
                                item.paymentType === "lunas"
                                  ? "success"
                                  : item.paymentType === "trial"
                                    ? "warning"
                                    : "accent"
                              }
                              accentColor={
                                item.paymentType === "cicil"
                                  ? "purple"
                                  : undefined
                              }
                            ...
                            {!item.paymentConfirmed && (
                              <UI.Badge
                                variant="default"
                                className="text-[8px]! bg-rose-500/10 text-rose-600 border-rose-500/20 px-1.5! py-0.5!"
                              >
                                Pending
                              </UI.Badge>
                            )}
                  ...
                  <div className="p-8 text-center flex flex-col items-center justify-center gap-4 py-20">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-xs text-zinc-500 dark:text-zinc-300 max-w-xs mt-1">
                        Pilih salah satu siswa dari daftar antrean sebelah kiri
                        untuk melakukan review dokumen, status promosi, atribusi
                        referral, dan persetujuan plotting.
                      </p>
                    </div>
                  </div>
                </UI.Card>
                  ...
                  <div className="p-5 flex flex-col gap-5 text-left relative">
                    ...
                    <div className="flex flex-col gap-1.5 text-xs text-zinc-700 dark:text-zinc-200">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-black ${selectedItem.paymentConfirmed ? "text-emerald-600 dark:text-emerald-400" : "text-rose-500"}`}
                        >
                      ...
                      {selectedItem.isGroup && selectedItem.groupMembers && (
                        <div className="mt-2.5 p-2.5 bg-purple-500/5 border border-purple-500/20 rounded-xl text-left">
                          <span className="text-[9.5px] font-bold text-purple-600 dark:text-purple-400 block mb-1.5 uppercase tracking-wider">
                            ...
                            {selectedItem.groupMembers.length} Anak):
                          </span>
                          <ol className="list-decimal list-inside text-[10px] text-purple-700 dark:text-purple-400 font-medium space-y-0.5">
                      ...
                      <div className="flex flex-col gap-1.5 text-xs text-zinc-700 dark:text-zinc-200">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-zinc-800 dark:text-zinc-200">
                            Rp{" "}
                            {selectedItem.originalPrice.toLocaleString("id-ID")}
                          </span>
                        </div>
                        {selectedItem.promoDiscount > 0 && (
                          <div className="flex justify-between text-rose-600 dark:text-rose-400">
                            ...
                            <span className="font-semibold">
                              -Rp{" "}
                              {selectedItem.promoDiscount.toLocaleString(
                                "id-ID",
                              )}
                            </span>
                          </div>
                    ...
                    {selectedItem.isGroup && (
                      <>
                        ...
                        <div className="bg-zinc-50 dark:bg-zinc-950/20 p-3 rounded-2xl border border-zinc-200/50 dark:border-zinc-850 flex flex-col gap-2 mb-3">
                          <span className="text-[9.5px] text-zinc-400 dark:text-zinc-400 font-bold block uppercase tracking-wider">
                            Mode Pembayaran Kelompok
                          </span>
                          <div className="flex gap-2 mt-1">
                            <button
                              type="button"
                              onClick={() =>
                                handleToggleGroupPaymentMode(
                                  selectedItem,
                                  "individual",
                                )
                              }
                    ...
                    <div className="flex flex-col gap-2.5">
                      ...
                      selectedItem.groupPaymentMode === "individual" ? (
                        <div className="flex flex-col gap-2">
                          {selectedItem.groupMemberPayments &&
                            selectedItem.groupMemberPayments.map((p, pIdx) => (
                              <div
                                key={pIdx}
                                className={
                                  getSubElementClass("inner-card") +
                              ...
                              >
                                ...
                                <div className="flex justify-between items-center mt-1">
                                  {p.status === "paid" ? (
                                    <>
                                      <span
                                        className="text-[9.5px] text-zinc-400 font-medium truncate max-w-[150px]"
                                        title={p.receiptUrl}
                                      >
                                        {p.receiptUrl}
                                      </span>
                                    ...
                                    <>
                                      ...
                                      <button
                                        type="button"
                                        onClick={() =>
                                          handleSimulateGroupMemberUpload(
                                            selectedItem,
                                            p.memberName,
                                          )
                                        }
                        ...
                        <div className="flex flex-col gap-2">
                          {selectedItem.installments &&
                            selectedItem.installments.map((term, tIdx) => (
                              <div
                                key={tIdx}
                                className={
                                  getSubElementClass("inner-card") +
                                  ...
                                  {term.status === "paid" ? (
                                    ...
                                    <>
                                      ...
                                      <button
                                        type="button"
                                        onClick={() =>
                                          handleSimulateInstallmentUpload(
                                            selectedItem,
                                            term,
                                          )
                                        }
                        ...
                        <div
                          className={
                            getSubElementClass("inner-card") +
                            " flex flex-col gap-2.5 text-xs text-left"
                          }
                        >
                          <div className="flex items-center justify-between gap-2 text-zinc-800 dark:text-zinc-250">
                            <div className="flex items-center gap-2 min-w-0">
                              ...
                              <span
                                ...
                                title={selectedItem.paymentReceiptUrl}
                              >
                                {selectedItem.paymentReceiptUrl}
                              </span>
                            </div>
                          ...
                          <div className="flex justify-between text-[10px] text-zinc-450 border-t border-zinc-150/40 pt-2">
                            ...
                            <span className="font-bold text-zinc-700 dark:text-zinc-300">
                              {selectedItem.paymentReceiptUploadedDate ||
                        ...
                        <div
                          className={`p-4 text-center text-xs ${getBorderRadiusClass(selectedStyle)} ${selectedStyle === "neobrutalism" ? "border-2 border-zinc-900" : "border"} border-rose-500/20 bg-rose-500/5`}
                        >
                          <span className="text-rose-500 font-bold block mb-2 text-left pl-1">
                            Bukti transfer belum diunggah
                          </span>
                          <button
                            type="button"
                            onClick={() =>
                              handleSimulateReceiptUpload(selectedItem)
                            }
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className={getSubElementClass("timeline-line")}>
                        {selectedItem.timeline.map((step, sIdx) => {
                          const isLast =
                            sIdx === selectedItem.timeline.length - 1;
                          return (
                            <div
                              key={sIdx}
                      ...
                      <div className="flex flex-col gap-2 mt-4 border-t border-zinc-150 dark:border-zinc-800 pt-4">
                        {!selectedItem.paymentConfirmed && (
                          <span className="text-[10px] text-rose-500 font-extrabold block text-center mb-1">
                            ⚠ Pembayaran belum terverifikasi. Selesaikan
                            pembayaran sebelum menyetujui.
                          </span>
                        )}
                        ...
                        <div className="flex gap-3">
                          <UI.Button
                            ...
                            className=" text-xs! py-2.5! font-semibold! cursor-pointer"
                          >
                            Tolak
                          </UI.Button>
                          <UI.Button
                ...
                <div className="flex flex-col gap-4 text-left">
                  ...
                  <div className="flex flex-col gap-3 py-1 text-xs">
                    ...
                    {confirmAction.type === "approve" ? (
                      <p className="text-[10px] text-zinc-500 dark:text-zinc-400 font-normal leading-normal italic">
                        * Setelah disetujui, pendaftaran akan otomatis masuk
                        antrean plotting mentor dan status akan diperbarui di
                        riwayat dashboard.
                      </p>
                    ) : (
                      <p className="text-[10px] text-rose-500/80 dark:text-rose-450/80 font-normal leading-normal italic">
                        * Setelah ditolak, pendaftaran akan ditutup dan email
                        pemberitahuan akan disimulasikan dikirim ke calon siswa.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2.5 justify-end mt-2 border-t border-zinc-150 dark:border-zinc-800 pt-4">
                    ...
                    <UI.Button
                      variant="primary"
                      accentColor={
                        confirmAction.type === "approve" ? "blue" : "red"
                      }
      ...
      <AnimatePresence>
        {toastMessage && (
          ...
          >
            <UI.Card
              accentColor={toastMessage.type === "success" ? "green" : "red"}
            >
                    ...
                    <div className="bg-white text-zinc-900 w-full max-w-[280px] p-5 rounded-xl shadow-xs border border-zinc-150 relative text-[10px] leading-relaxed">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between border-b border-zinc-50 pb-1">
                          ...
                          <span
                            className="font-extrabold text-zinc-800 truncate max-w-[140px]"
                            title={
                              selectedGroupMemberPayment
                                ? selectedGroupMemberPayment.memberName.toUpperCase()
                      ...
                      <div className="text-center border-t border-dashed border-zinc-200 pt-3 mt-3 text-[8px] text-zinc-400 font-mono">
                        NO REFERENSI: TRF-
                        {selectedItem.id.replace("REG-", "882030")}
                        {selectedGroupMemberPayment
