        ...
        <div className="flex flex-wrap gap-2.5">
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-colors cursor-pointer ${statusFilter === tab.id ? "bg-sakode-blue text-white shadow-3xs" : "bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-805 dark:hover:bg-zinc-700 text-zinc-550 dark:text-zinc-300"}`}
            >
              {tab.label}
            </button>
          ))}
