...
export function AdminWidget() {
  ...
  const pendingRegistrations = [
    { id: "REG-001", title: "Dzulkifli Putra", refLabel: "Ref: Akbar", programLabel: "React & Next", dateOnly: "13/03/26", date: "13/03/26 16:30", desc: "React & Next.js Professional • via Ref: Akbar" },
    { id: "REG-002", title: "Endah Lestari", refLabel: "Ref: Mandiri", programLabel: "TypeScript & Structures", dateOnly: "13/03/26", date: "13/03/26 14:15", desc: "TypeScript & Data Structures • via Ref: MANDIRI" },
    { id: "REG-003", title: "Rian Hidayat", refLabel: "No Ref", programLabel: "Backend Dev Go/Docker", dateOnly: "12/03/26", date: "12/03/26 18:22", desc: "Backend Dev Go/Docker • Tanpa Referral" }
  ];
                ...
                <div className="p-5 flex flex-col gap-3 text-left">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {ticket.refLabel !== "No Ref" ? (
                      ...
                      <UI.Badge variant="default" className="text-[9px]! font-medium! px-2! py-0.5!">
                        No Ref
                      </UI.Badge>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <UI.Button 
                      ...
                      onClick={() => router.push(`/registration-review?id=${ticket.id}`)}
